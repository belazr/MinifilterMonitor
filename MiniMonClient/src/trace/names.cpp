...
namespace {
    ...
    constexpr FlagName PERSISTENT_VOLUME_STATE_NAMES[]{
        { PERSISTENT_VOLUME_STATE_SHORT_NAME_CREATION_DISABLED,    L"PERSISTENT_VOLUME_STATE_SHORT_NAME_CREATION_DISABLED" },
        { PERSISTENT_VOLUME_STATE_VOLUME_SCRUB_DISABLED,           L"PERSISTENT_VOLUME_STATE_VOLUME_SCRUB_DISABLED" },
        { PERSISTENT_VOLUME_STATE_GLOBAL_METADATA_NO_SEEK_PENALTY, L"PERSISTENT_VOLUME_STATE_GLOBAL_METADATA_NO_SEEK_PENALTY" },
        { PERSISTENT_VOLUME_STATE_LOCAL_METADATA_NO_SEEK_PENALTY,  L"PERSISTENT_VOLUME_STATE_LOCAL_METADATA_NO_SEEK_PENALTY" },
        { PERSISTENT_VOLUME_STATE_NO_HEAT_GATHERING,               L"PERSISTENT_VOLUME_STATE_NO_HEAT_GATHERING" },
        { PERSISTENT_VOLUME_STATE_CONTAINS_BACKING_WIM,            L"PERSISTENT_VOLUME_STATE_CONTAINS_BACKING_WIM" },
        { PERSISTENT_VOLUME_STATE_BACKED_BY_WIM,                   L"PERSISTENT_VOLUME_STATE_BACKED_BY_WIM" },
        { PERSISTENT_VOLUME_STATE_NO_WRITE_AUTO_TIERING,           L"PERSISTENT_VOLUME_STATE_NO_WRITE_AUTO_TIERING" },
        { PERSISTENT_VOLUME_STATE_TXF_DISABLED,                    L"PERSISTENT_VOLUME_STATE_TXF_DISABLED" },
        { PERSISTENT_VOLUME_STATE_REALLOCATE_ALL_DATA_WRITES,      L"PERSISTENT_VOLUME_STATE_REALLOCATE_ALL_DATA_WRITES" },
        { PERSISTENT_VOLUME_STATE_CHKDSK_RAN_ONCE,                 L"PERSISTENT_VOLUME_STATE_CHKDSK_RAN_ONCE" },
        { PERSISTENT_VOLUME_STATE_MODIFIED_BY_CHKDSK,              L"PERSISTENT_VOLUME_STATE_MODIFIED_BY_CHKDSK" },
        { PERSISTENT_VOLUME_STATE_DAX_FORMATTED,                   L"PERSISTENT_VOLUME_STATE_DAX_FORMATTED" },
        { PERSISTENT_VOLUME_STATE_DEV_VOLUME,                      L"PERSISTENT_VOLUME_STATE_DEV_VOLUME" },
        { PERSISTENT_VOLUME_STATE_TRUSTED_VOLUME,                  L"PERSISTENT_VOLUME_STATE_TRUSTED_VOLUME" },
    };
        ...
        namespace names {
            ...
            std::wstring RenderIoControlCode(uint32_t ioControlCode) {
                ...
                switch (ioControlCode) {
                    ...
                    case IOCTL_VOLUME_SUPPORTS_ONLINE_OFFLINE:             return L"IOCTL_VOLUME_SUPPORTS_ONLINE_OFFLINE";
                    case IOCTL_VOLUME_IS_OFFLINE:                          return L"IOCTL_VOLUME_IS_OFFLINE";
                    case IOCTL_VOLUME_IS_IO_CAPABLE:                       return L"IOCTL_VOLUME_IS_IO_CAPABLE";
                    case IOCTL_VOLUME_QUERY_FAILOVER_SET:                  return L"IOCTL_VOLUME_QUERY_FAILOVER_SET";
                    case IOCTL_VOLUME_QUERY_VOLUME_NUMBER:                 return L"IOCTL_VOLUME_QUERY_VOLUME_NUMBER";
                    case IOCTL_VOLUME_LOGICAL_TO_PHYSICAL:                 return L"IOCTL_VOLUME_LOGICAL_TO_PHYSICAL";
                    case IOCTL_VOLUME_PHYSICAL_TO_LOGICAL:                 return L"IOCTL_VOLUME_PHYSICAL_TO_LOGICAL";
                    case IOCTL_VOLUME_IS_PARTITION:                        return L"IOCTL_VOLUME_IS_PARTITION";
                    case IOCTL_VOLUME_READ_PLEX:                           return L"IOCTL_VOLUME_READ_PLEX";
                    case IOCTL_VOLUME_SET_GPT_ATTRIBUTES:                  return L"IOCTL_VOLUME_SET_GPT_ATTRIBUTES";
                    case IOCTL_VOLUME_GET_BC_PROPERTIES:                   return L"IOCTL_VOLUME_GET_BC_PROPERTIES";
                    case IOCTL_VOLUME_ALLOCATE_BC_STREAM:                  return L"IOCTL_VOLUME_ALLOCATE_BC_STREAM";
                    case IOCTL_VOLUME_FREE_BC_STREAM:                      return L"IOCTL_VOLUME_FREE_BC_STREAM";
                    case IOCTL_VOLUME_IS_DYNAMIC:                          return L"IOCTL_VOLUME_IS_DYNAMIC";
                    case IOCTL_VOLUME_PREPARE_FOR_CRITICAL_IO:             return L"IOCTL_VOLUME_PREPARE_FOR_CRITICAL_IO";
                    case IOCTL_VOLUME_QUERY_ALLOCATION_HINT:               return L"IOCTL_VOLUME_QUERY_ALLOCATION_HINT";
                    case IOCTL_VOLUME_UPDATE_PROPERTIES:                   return L"IOCTL_VOLUME_UPDATE_PROPERTIES";
                    case IOCTL_VOLUME_QUERY_MINIMUM_SHRINK_SIZE:           return L"IOCTL_VOLUME_QUERY_MINIMUM_SHRINK_SIZE";
                    case IOCTL_VOLUME_PREPARE_FOR_SHRINK:                  return L"IOCTL_VOLUME_PREPARE_FOR_SHRINK";
                    case IOCTL_VOLUME_IS_CSV:                              return L"IOCTL_VOLUME_IS_CSV";
                    case IOCTL_VOLUME_POST_ONLINE:                         return L"IOCTL_VOLUME_POST_ONLINE";
                    case IOCTL_VOLUME_GET_CSVBLOCKCACHE_CALLBACK:          return L"IOCTL_VOLUME_GET_CSVBLOCKCACHE_CALLBACK";
                    case kernel::IOCTL_MOUNTDEV_QUERY_UNIQUE_ID:           return L"IOCTL_MOUNTDEV_QUERY_UNIQUE_ID";
                    case kernel::IOCTL_MOUNTDEV_QUERY_SUGGESTED_LINK_NAME: return L"IOCTL_MOUNTDEV_QUERY_SUGGESTED_LINK_NAME";
                    case kernel::IOCTL_MOUNTDEV_LINK_CREATED:              return L"IOCTL_MOUNTDEV_LINK_CREATED";
                    case kernel::IOCTL_MOUNTDEV_LINK_DELETED:              return L"IOCTL_MOUNTDEV_LINK_DELETED";
                    case kernel::IOCTL_MOUNTDEV_QUERY_STABLE_GUID:         return L"IOCTL_MOUNTDEV_QUERY_STABLE_GUID";
                    case kernel::IOCTL_MOUNTDEV_QUERY_INTERFACE_NAME:      return L"IOCTL_MOUNTDEV_QUERY_INTERFACE_NAME";
                    case kernel::IOCTL_MOUNTDEV_QUERY_DEVICE_NAME:         return L"IOCTL_MOUNTDEV_QUERY_DEVICE_NAME";
                }
