...
namespace mimo {
    ...
    namespace capture {
        ...
        void PopulatePreOperationRecordData(
            ...
            _In_ const UNICODE_STRING* pEcpData
        );

        void PopulatePostOperationRecordData(_Inout_ protocol::RecordData* pRecordData, _In_ const FLT_CALLBACK_DATA* pData, _In_ ULONG transactionSequence);
